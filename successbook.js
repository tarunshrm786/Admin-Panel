...
//        document.getElementById("url").innerHTML = BookImageURL;
            
            content += '<tr>';
            
            content += "<td style='text-align:center;display: table-cell;vertical-align: middle;'><a href="+BookImageURL+" ><img src='bookimg.png' alt='imageurl' align='center' width='50' >  </a></td>"; //column1
            
            content += "<td style='text-align:center;display: table-cell;vertical-align: middle;'><a href="+BookPdfUrl+" ><img src='pdf.png' alt='imageurl' width='50'>  </a></td>";//column2 
